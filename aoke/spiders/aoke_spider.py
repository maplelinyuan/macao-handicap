...
# 要查询赔率的公司
info_days = 1800  # 收集多少天的信息  1表示当天分析
# 712 天 84 523 3046 select_league_list = ['西甲','德甲','苏超','友谊赛','澳超','荷甲','荷乙','美联']
# 712 天 160.5 3079 23612 全部
# 1800 天 74 1197 7088 select_league_list = ['西甲','德甲','苏超','友谊赛','澳超','荷甲','荷乙','美联']
